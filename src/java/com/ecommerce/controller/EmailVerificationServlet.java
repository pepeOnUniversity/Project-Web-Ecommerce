...
public class EmailVerificationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (token == null || token.trim().isEmpty()) {
            // Không có token, hiển thị trang yêu cầu xác minh
        ...
        if (user == null) {
            ...
            // Thử tìm tất cả tokens trong database để debug (chỉ trong development)
            // TODO: Xóa phần này trong production
            System.out.println("=== DEBUG: Kiểm tra database ===");
